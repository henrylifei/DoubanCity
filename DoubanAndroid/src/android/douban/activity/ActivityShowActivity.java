...
public class ActivityShowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			Log.i("检验", city);
			SubjectFeed feed = myService.findActivity(city,"all", 1, 5);
		...
		list.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(ActivityShowActivity.this, DetailActivity.class);
