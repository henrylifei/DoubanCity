...
/**
 * A helper class that helps building queries for the Douban feeds.
 * 
 * Not all feeds implement all parameters defined on this class. See the
 * documentation to get the list of parameters each feed supports.
 * 
 * 
 */
public class SubjectQuery extends DoubanQuery {
	...
	public String getType() {
		return getCustomParameterValue(TYPE);
	}
	
	public void setType(String type) {
		if (type != null)
			overwriteCustomParameter(TYPE, type);
	}
