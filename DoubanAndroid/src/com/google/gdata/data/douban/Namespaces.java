...
public class Namespaces {
	...
	public static final String activitySubjectURL = "http://api.douban.com/event";
	public static final String activitySubjectsURL="http://api.douban.com/event/location/";
	public static final String participateActivityURL="http://api.douban.com/event/";
	...
	public static final XmlWriter.Namespace gNs = new XmlWriter.Namespace(
			gAlias, g);

	public static final XmlWriter.Namespace doubanNs = new XmlWriter.Namespace(
			doubanAlias, doubanNamespace);

	public static final XmlWriter.Namespace atomNS = new XmlWriter.Namespace(
			atomAlias, atomNamespace);
